...
1. Get an API key at https://lumenfall.ai/app/api_keys ($1 starter credit, no
   card needed). New accounts can also drop into the Discord
   (https://discord.gg/CUPVN87u) and share what they're building for a few
   extra dollars of credits.
2. Export the key:
